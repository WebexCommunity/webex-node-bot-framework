...
/**
 * @description Flint Object Validation
 *
 * @name Validator
 * @namespace Validator
 */
...
/**
 * @description Validate an initialized flint object
 *
 * @function
 * @memberof Validator
 * @param {object} flint A Flint object
 * @returns {boolean} If flint object is valid
 */
Validator.isFlint = (flint) => {
  const result = (typeof flint === 'object'
    && (typeof flint.id === 'string')
    && (typeof flint.active === 'boolean')
    && (typeof flint.initialized === 'boolean')
    && (typeof flint.isBotAccount === 'boolean')
    && (typeof flint.isUserAccount === 'boolean')
    && (typeof flint.options === 'object')
    && (typeof flint.person === 'object')
    && (typeof flint.email === 'string')
    && (typeof flint.webex === 'object')
    && (typeof flint.bots === 'object')
  );
  return result;
};
 ...
 * valid options for flint constructor
 * @returns {Boolean} result
 */
