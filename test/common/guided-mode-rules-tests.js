...
paramCombos = [
  ...
  {"membershipRulesDisallowedResponse": "No guides in this space I ain't working"},
  {"membershipRulesDisallowedResponse": "No guides in this space I ain't working",
...
// // Run the test with the default bot messages for guide mode
// describe('Run Guide Mode tests with different guide mode params', () => {
//   it("Runs with the default framework options", () => {
//     run_guide_mode_test_suite();
//   });

//   it("Runs with the membershipRulesDisallowedResponse set to ''", () => {
...
// run_guide_mode_test_suite()
//   .then(response => {
//   // Repeat test disabling the msg from bot when added to a space w/out guides
//   // With & without dissallowed members using default guide mode messages
//   console.log('First set of tests ran with response:')
...
// This is stuff that was commented at the end of the outermost describe
